...
In order to make it easy, we also provide access to the training set on S3:
https://s3.console.aws.amazon.com/s3/buckets/criteo-display-ctr-dataset/data/training/?region=us-east-1&tab=overview
This corresponds to the 23 first days of data shuffled.

And the validation set: 
https://s3.console.aws.amazon.com/s3/buckets/criteo-display-ctr-dataset/data/validation/?region=us-east-1&tab=overview
that is the last day data shuffled.
